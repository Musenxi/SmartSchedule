...
import { X, Calendar as CalendarIcon, Trash2, AlertTriangle, Check } from 'lucide-react';
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-3 py-2 bg-background border border-input rounded-lg focus:outline-none focus:ring-1 focus:ring-primary pl-10"
                            />
